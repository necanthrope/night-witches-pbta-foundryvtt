...
export const preloadHandlebarsTemplates = async function () {
    return loadTemplates([
        ...
        'modules/night-witches-pbta-foundryvtt/templates/parts/actor-experience.hbs',
        ...
        'modules/night-witches-pbta-foundryvtt/templates/parts/widgets/actor-listmany.hbs',
        'modules/night-witches-pbta-foundryvtt/templates/parts/widgets/actor-longtext.hbs',
    ]);
